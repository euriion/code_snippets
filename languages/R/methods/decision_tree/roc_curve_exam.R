...
# http://www.r-bloggers.com/an-example-of-roc-curves-plotting-with-rocr/
...
active <- read.table(file="https://raw.github.com/chupvl/R_scripts/master/sample.active", sep=",", header=FALSE)
# loading inactive compounds, or compounds with label2
inactive <- read.table("https://raw.github.com/chupvl/R_scripts/master/sample.inactive", sep=",", header=FALSE)
