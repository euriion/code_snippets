...
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(fun=df1)
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(fun=df2)
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(fun=df3)
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(fun=df4)
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(fun=df5)
ggplot(data.frame(x=c(0, 2)), aes(x)) + stat_function(aes(x), fun=c(df1))  + stat_function(aes(x), fun=c(df2))
