...
#TERM="search.bucketbar.bucket_label"
TERM="search.bucketbar.no_bucket"
for INTL in $INTLS; do
    echo -n $INTL
    # backup
    #r3 translation view vertical/$INTL $TERM > ./$TERM.$INTL.backup
    r3 translation view vertical/$INTL $TERM
    #r3 translation set vertical/$INTL $TERM "Bucket:"
done
